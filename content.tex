...
#define VIRTIO_NET_HDR_F_HAS_RSC       3
#define VIRTIO_NET_HDR_F_HAS_RSS       4
        u8 flags;
...
\paragraph{RSS}\label{sec:Device Types / Network Device / Device Operation / Control Virtqueue / RSS}
...
#define VIRTIO_NET_CTRL_RSS_SET                       1
\end{lstlisting}
...
\devicenormative{\subparagraph}{RSS}{Device Types / Network Device / Device Operation / Control Virtqueue / RSS}

The device SHOULD fill the virtio_net_ctrl_rss_hash structure with the hash
functions it supports and return the structure to the driver. Zero or more
flags of the RSS_HASH_FUNCTION flags should be used to fill the \field{hash_function}
field.
...
\drivernormative{\subparagraph}{RSS}{Device Types / Network Device / Device Operation / Control Virtqueue / RSS}

If the driver negotiates the feature VIRTIO_NET_F_CTRL_RSS is negotiated the
driver SHOULD send VIRTIO_NET_CTRL_RSS_SET command to the device along with the
RSS structure filled. The RSS structure fields should be filled as follows:
...
\item The driver SHOULD choose the hash function that SHOULD be used and fill
	...
	in the \field{hash_function_flags} field. These flags inidicates to the
